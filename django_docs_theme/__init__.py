...
def validate_github_actions_config(app: Any) -> None:
    ...
    1. 'django_docs_theme' is present in app.config.extensions
    ...
    if "django_docs_theme" not in extensions:
        missing_requirements.append(
            "• 'django_docs_theme' deve estar listado em 'extensions = [...]' no seu docs/conf.py."
        )
    ...
    if missing_requirements:
        error_msg = (
            "\n"
            "================================================================================\n"
            "[django_docs_theme] ERRO DE CONFIGURAÇÃO NO GITHUB ACTIONS\n"
            "================================================================================\n"
