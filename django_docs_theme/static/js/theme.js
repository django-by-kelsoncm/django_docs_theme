...
function initMobileMenu() {
  ...
  const headerNav = document.getElementById('django-header-nav');
...
function initExternalLinks() {
  const links = document.querySelectorAll('.django-content a[href^="http://"], .django-content a[href^="https://"]');
